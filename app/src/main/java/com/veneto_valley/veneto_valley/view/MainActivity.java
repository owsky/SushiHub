...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private final ActivityResultLauncher<Intent> requestWifiLauncher =
            registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> Toast.makeText(this, "SushiHub requires WiFi to work", Toast.LENGTH_SHORT).show());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        // it handles navigation manually so that the actions can be customized depending on the app's status
